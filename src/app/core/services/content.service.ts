...
1) التصميم الفني: عملية لتنظيم وتوظيف عناصر الفن المختلفة وفق أسس جمالية محددة بهدف إنتاج عمل فني متكامل يجمع بين الجمال والوظيفة، ويتفرع منه: مفهوم التصميم، أهمية التصميم، التصميم الرقمي، موضوع التصميم، طريقة التصميم، وظيفة التصميم، التصميم الزخرفي.
2) عناصر التصميم: مجموعة من المكونات البصرية التي يتم توظيفها رقميًا داخل التصميم الافتراضي، بهدف بناء التكوين الفني وتحقيق التأثير البصري والجمالي، وتتفرع إلى: النقطة، الخط، الشكل، الحجم، الملمس، الإضاءة، اللون.
3) عمليات التصميم: إجراءات وأساليب رقمية تستخدم داخل المعمل الافتراضي لتنظيم عناصر التصميم وتوزيعها بطريقة تحقق الإيقاع البصري والتوازن والتنوع، وتتفرع إلى: التكرار، التنوع، التدرج.
4) أسس التصميم: مجموعة من المبادئ التنظيمية التي تحكم توظيف عناصر التصميم رقميًا داخل المعمل الافتراضي بما يضمن تحقيق التوازن والانسجام، وتتفرع إلى: الأسس الاتجاهية، الأسس التركيزية، الأسس المركبة.
5) الأسس الإنشائية للتصميم: إطار مفاهيمي ينظم بناء التصميم الافتراضي من حيث العلاقات البصرية والقيم الجمالية والوظيفية، ويتفرع إلى: مقابلات التصميم، قيم التصميم.
6) التصميم الرقمي: استخدام التقنيات الرقمية والبرمجيات الحاسوبية في إنتاج وتصميم الأعمال الفنية بما يتيح التفاعل والمحاكاة الافتراضية، ويتفرع إلى: النقطة الرقمية، الخط الرقمي، الشكل الرقمي، اللون الرقمي، الحركة الرقمية.
            `.trim(),
