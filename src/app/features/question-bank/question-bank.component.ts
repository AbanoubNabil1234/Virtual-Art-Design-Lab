    ...
    <div class="qb-container animate-fade-in">
        ...
        <div class="categories-view" *ngIf="!selectedCategory()">
            ...
            <div class="categories-grid">
                <div class="category-card" data-sound="select" *ngFor="let cat of categories" (click)="selectCategory(cat)">
                    <div class="cat-icon">
                ...
                <div class="category-card all-cat" data-sound="start" (click)="selectCategory('الكل')">
                    <div class="cat-icon">
        ...
        <div class="quiz-view" *ngIf="selectedCategory()">
            <div class="quiz-header">
                <button (click)="selectedCategory.set(null)" class="back-btn" data-sound="back">
            ...
            <div class="action-footer" *ngIf="!isSubmitted">
                <button (click)="submitQuiz()" class="submit-btn" data-sound="submit" [disabled]="Object.keys(userAnswers).length !== activeQuestions().length">
                    تسليم الإجابات
                </button>
            </div>
             <div class="action-footer" *ngIf="isSubmitted">
                <button (click)="resetQuiz()" class="reset-btn" data-sound="reset">
                    إعادة المحاولة
                </button>
            </div>
        </div>
...
export class QuestionBankComponent {
    ...
    submitQuiz() {
        ...
        const passed = this.score >= Math.ceil(this.activeQuestions().length / 2);
        setTimeout(() => this.buttonSound.play(passed ? 'success' : 'wrong'), 200);
    }
